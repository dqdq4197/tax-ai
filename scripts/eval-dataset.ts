...
export const GOLDEN_DATASET: EvalCase[] = [
...

  {
    ...
    messages: [
      ...
      },
      {
        role: "assistant",
        content:
          "컴퓨터 프로그래밍 서비스(940909)와 소프트웨어 개발 및 공급(940902) 중 어느 쪽에 가까우세요?",
      },
    ...
    messages: [
      {
        role: "user",
        content:
          "올해 처음 디자인 프리랜서 시작했어. 2024년 수입 3천만원인데 세금 얼마야?",
      },
      {
        role: "assistant",
        content: "신규 사업자시군요! 부양가족은 있으세요? 국민연금 내셨나요?",
      },
      {
        role: "user",
        content: "부양가족 없고 국민연금 안 냈어. 작년 수입은 없어.",
      },
    ],
    expect: { toolCalled: "tax_calculator" },
  },

  {
    ...
    messages: [
      {
        role: "user",
        content: "2023년 세금 계산하고 싶어. 웹디자이너 프리랜서야.",
      },
      { role: "assistant", content: "2023년 귀속이군요. 총 수입이 얼마예요?" },
      {
        role: "user",
        content:
          "5천만원이야. 작년(2022년) 수입은 4천만원. 부양가족 없고 국민연금 150만원 냈어.",
      },
    ],
    expect: { toolCalled: "tax_calculator" },
  },
    ...
    messages: [
      {
        role: "user",
        content:
          "2025년 세금 계산해줘. IT 프리랜서고 수입 6천만원, 작년 4천만원.",
      },
    ...
    messages: [
      {
        role: "user",
        content:
          "2026년 귀속 종합소득세 계산해줘. 번역 프리랜서고 수입 4천만원이야.",
      },
      {
        role: "assistant",
        content:
          "2026년 귀속은 경비율이 아직 미발표라 2025년 기준으로 예상 세액을 안내해드릴게요. 작년(2025년) 수입과 부양가족 수를 알려주세요.",
      },
      {
        role: "user",
        content: "작년 수입 3500만원, 부양가족 없어. 국민연금 안 냈어.",
      },
    ],
    expect: { toolCalled: "tax_calculator" },
  },
    ...
    messages: [
      {
        role: "user",
        content:
          "소프트웨어 컨설팅 프리랜서야. 2024년 수입이 3억 2천만원이야. 작년은 2억 8천만원. 부양가족 없어.",
      },
      {
        role: "assistant",
        content: "주요경비(매입·임차·인건비)가 있으신가요?",
      },
    ...
    messages: [
      {
        role: "user",
        content:
          "학원 강사 프리랜서야. 2024년 수입 5천만원, 작년 4500만원. 부양가족 3명이고 국민연금 180만원 냈어.",
      },
      {
        role: "assistant",
        content:
          "강의 유형이 어떻게 되세요? 학원 강의인지 개인 과외인지에 따라 업종코드가 달라져요.",
      },
    ...
    messages: [
      {
        role: "user",
        content:
          "소규모 음식점 운영해. 2024년 수입 5천만원, 작년 4천만원. 일자리안정자금 300만원 받았어.",
      },
      {
        role: "assistant",
        content: "부양가족은 계신가요? 주요경비(매입·임차·인건비)가 있나요?",
      },
      {
        role: "user",
        content:
          "부양가족 없어. 매입 1000만원, 임차 600만원, 인건비 800만원. 국민연금 안 냈어.",
      },
    ],
    expect: { toolCalled: "tax_calculator" },
  },
    ...
    messages: [
      {
        role: "user",
        content:
          "번역 프리랜서야. 2024년 수입 4800만원, 작년 3900만원. 국민연금 216만원 냈어. 부양가족 없어.",
      },
      {
        role: "assistant",
        content:
          "출판번역인지 통역인지에 따라 업종코드가 달라져요. 어떤 유형이세요?",
      },
...

  {
    ...
    messages: [
      {
        role: "user",
        content: "유튜버인데 2024년 광고 수익 4500만원이야. 세금 계산해줘.",
      },
      {
        role: "assistant",
        content:
          "유튜브 수익은 인적용역 사업소득이에요. 작년 수입은 얼마였나요? 부양가족·국민연금도 알려주세요.",
      },
      {
        role: "user",
        content: "작년 3200만원, 부양가족 없어, 국민연금 안 냈어.",
      },
    ],
    expect: { toolCalled: "tax_calculator" },
  },

  {
    ...
    messages: [
      {
        role: "user",
        content: "배달 플랫폼 라이더야. 2024년에 3800만원 벌었어. 세금 얼마야?",
      },
      {
        role: "assistant",
        content:
          "배달 라이더는 운송 인적용역 사업소득이에요. 작년 수입과 부양가족·국민연금을 알려주세요.",
      },
      {
        role: "user",
        content: "작년 3100만원, 부양가족 1명, 국민연금 안 냈어.",
      },
    ],
    expect: { toolCalled: "tax_calculator" },
  },
    ...
    messages: [
      {
        role: "user",
        content:
          "웹툰 그리는데 2024년 원고료 수입 6천만원이야. 작년은 5천만원. 부양가족 없고 국민연금 216만원 냈어.",
      },
      {
        role: "assistant",
        content: "웹툰 창작은 인적용역 사업소득이에요. 주요경비는 있으신가요?",
      },
    ...
    messages: [
      {
        role: "user",
        content:
          "웨딩 사진 찍는 프리랜서야. 2024년 수입 3500만원, 작년 2800만원. 부양가족 2명이야.",
      },
      {
        role: "assistant",
        content: "국민연금 내셨나요? 주요경비는 있으신가요?",
      },
...

  {
    ...
    messages: [
      { role: "user", content: "종합소득세 세율이 어떻게 돼? 몇 % 내야 해?" },
    ],
    expect: {
      toolCalled: "vector_search",
      toolNotCalled: "tax_calculator",
...

  {
    ...
    messages: [
      { role: "user", content: "표준세액공제가 뭐야? 얼마나 받을 수 있어?" },
    ],
    expect: {
      toolCalled: "vector_search",
      toolNotCalled: "tax_calculator",
...

  {
    ...
    messages: [
      {
        role: "user",
        content: "단순경비율 적용받으려면 수입이 얼마 이하여야 해?",
      },
    ],
    expect: {
      toolCalled: "vector_search",
...

  {
    ...
    messages: [
      {
        role: "user",
        content: "기준경비율 방식에서 주요경비가 뭐야? 어떤 게 포함돼?",
      },
    ],
    expect: {
      toolCalled: "vector_search",
...

  {
    ...
    messages: [
      {
        role: "user",
        content: "유튜버 수익이나 블로그 광고 수익도 사업소득이야?",
      },
    ],
    expect: {
      toolCalled: "vector_search",
...

  {
    ...
    messages: [
      {
        role: "user",
        content: "소득공제랑 세액공제가 어떻게 달라? 뭐가 더 유리해?",
      },
    ],
    expect: {
      toolCalled: "vector_search",
...

  {
    ...
    messages: [
      { role: "user", content: "프리랜서 수당 받을 때 3.3% 떼이는 게 뭐야?" },
    ],
    expect: {
      toolCalled: "vector_search",
      toolNotCalled: "tax_calculator",
...

  {
    ...
    category: "legal",
    description:
      "투잡 — 복수 소득 합산 신고 의무 (구어체 → 법령 용어 변환 검증)",
    messages: [
      {
        role: "user",
        content: "투잡인데 세금 신고 어떻게 해? 따로 따로 내야 해?",
      },
    ],
    expect: {
      toolCalled: "vector_search",
    ...
    messages: [
      {
        role: "user",
        content:
          "외부 강의 한 번 하고 강의료 받으면 사업소득이야 기타소득이야?",
      },
    ],
    expect: {
      toolCalled: "vector_search",
...

  {
    ...
    messages: [
      {
        role: "user",
        content: "종합소득세 신고 안 하면 어떻게 돼? 가산세 있어?",
      },
    ],
    expect: {
      toolCalled: "vector_search",
...

  {
    ...
    messages: [
      { role: "user", content: "소득세법 시행령 제143조 내용이 뭐야?" },
    ],
    expect: {
      toolCalled: "law_article_lookup",
...

  {
    ...
    messages: [
      { role: "user", content: "아파트 월세 받는데 임대소득세 얼마야?" },
    ],
    expect: {
      toolNotCalled: "tax_calculator",
...

  {
    ...
    messages: [
      { role: "user", content: "주식 배당금 3천만원 받았는데 세금 얼마야?" },
    ],
    expect: {
      toolNotCalled: "tax_calculator",
...

  {
    ...
    messages: [
      {
        role: "user",
        content: "퇴직연금 받기 시작했는데 연금소득세 계산해줘.",
      },
    ],
    expect: {
      toolNotCalled: "tax_calculator",
...

  {
    ...
    messages: [
      {
        role: "user",
        content: "비트코인 팔아서 2천만원 벌었는데 세금 내야 해?",
      },
    ],
    expect: {
      toolNotCalled: "tax_calculator",
    ...
    messages: [
      {
        role: "user",
        content:
          "직장 다니면서 부업으로 프리랜서도 해. 연봉 4천만원이고 프리랜서 수입 1500만원인데 세금 계산해줘.",
      },
    ],
    expect: {
      toolNotCalled: "tax_calculator",
...

  {
    ...
    messages: [
      { role: "user", content: "디자이너 프리랜서야. 세금 계산해줘." },
    ],
...

  {
    ...
    messages: [
      { role: "user", content: "세금 계산하고 싶어. 수입 3000만원이야." },
    ],
    expect: { toolNotCalled: "tax_calculator" },
  },
    ...
    messages: [
      {
        role: "user",
        content:
          "2024년 음식점 운영해서 2억 벌었어. 작년도 1억 8천만원. 부양가족 없어. 세금 계산해줘.",
      },
    ],
    expect: { toolNotCalled: "tax_calculator" },
  },

  {
    ...
    messages: [
      { role: "user", content: "프리랜서야. 2024년 수입 5000만원. 계산해줘." },
    ],
    expect: { toolNotCalled: "tax_calculator" },
  },
];
